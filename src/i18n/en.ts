...
export const en = {
  ...
  insights: {
    ...
    headingOther: (name: string) => `${name}'s movie profile`,
    thisUser: "This user",
    ...
    bestYear: "Best year in film",
    bestYearBody: (count: number, title: string) =>
      `${count} watched from that year. Top pick: ${title}`,
    busiestMonth: "Most cinephile month",
    busiestMonthBody: (count: number) => `${count} movies watched`,
    personalityLabel: "You are",
    personalityLabelOther: "Is",
    personality: {
      27: "a horror devotee",
      18: "a drama lover",
      35: "a comedy fan",
